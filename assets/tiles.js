...
const TILES = {
    ...
    BARREL:   { id: 11, color: '#7a5c3a', solid: true, label: 'barrel', overlay: true, ground: 'grass' },
    FLOWER:   { id: 12, color: '#d65d8c', solid: true, label: 'flower', overlay: true, ground: 'grass' },
    ...
    FOUNTAIN: { id: 20, color: '#6eb5d6', solid: true,  label: 'fountain', overlay: true, ground: 'cobble' },
